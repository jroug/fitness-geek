...
const ChartsWorkoutsPage: React.FC = () => {
  ...
  return (
      ...
      <section className="overflow-hidden rounded-3xl bg-gradient-to-r from-slate-900 via-sky-900 to-cyan-700 p-6 text-white shadow-xl md:p-8">
            ...
            <h1 className="mt-2 text-2xl font-bold md:text-3xl">Workout Duration</h1>
            <p className="mt-2 text-sm text-cyan-100">Track your workout duration over time and compare weekly change trends.</p>
      </section>
